...
from dataset import PixelSetData, PixelSetData_preloaded, custom_collate
...
if __name__ == '__main__':
    ...
    parser.add_argument('--npixel', default=128, type=int, help='Number of pixels to sample from the input images')
    ...
    parser.add_argument('--lms', default=180, type=int,
